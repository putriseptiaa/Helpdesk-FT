...
return new class extends Migration
{
    ...
    {
        Schema::create('transwflegalisasi', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('legalisasi_id');
            $table->foreign('legalisasi_id')->references(coloum:'id')->on(table:'legalisasi');
    ...
    {
        Schema::dropIfExists('transwflegalisasi');
    }
};
