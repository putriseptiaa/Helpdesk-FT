...
return new class extends Migration
{
    ...
    {
        Schema::create('transwfsta', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('pengajuansta_id');
            $table->foreign('pengajuansta_id')->references(coloum:'id')->on(table:'pengajuansta');
    ...
    {
        Schema::dropIfExists('transwfsta');
    }
};
