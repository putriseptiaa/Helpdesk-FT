...
return new class extends Migration
{
    ...
    {
        Schema::create('transwfbpit', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('pengajuanbpit_id');
            $table->foreign('pengajuanbpit_id')->references(coloum:'id')->on(table:'pengajuanbpit');
    ...
    {
        Schema::dropIfExists('transwfbpit');
    }
};
