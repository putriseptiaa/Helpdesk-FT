...
return new class extends Migration
{
    ...
    {
        Schema::create('transwfskp', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('pengajuanskp_id');
            $table->foreign('pengajuanskp_id')->references(coloum:'id')->on(table:'pengajuanskp');
    ...
    {
        Schema::dropIfExists('transwfskp');
    }
};
