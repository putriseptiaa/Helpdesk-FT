...
return new class extends Migration
{
    ...
    {
        Schema::create('transwfulkp', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('pengajuanulkp_id');
            $table->foreign('pengajuanulkp_id')->references(coloum:'id')->on(table:'pengajuanulkp');
    ...
    {
        Schema::dropIfExists('transwfulkp');
    }
};
