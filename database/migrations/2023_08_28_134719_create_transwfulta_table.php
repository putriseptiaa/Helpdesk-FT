...
return new class extends Migration
{
    ...
    {
        Schema::create('transwfulta', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('pengajuanulta_id');
            $table->foreign('pengajuanulta_id')->references(coloum:'id')->on(table:'pengajuanulta');
    ...
    {
        Schema::dropIfExists('transwfulta');
    }
};
